...
def load_model(model_name: str,
    ...
    if not isinstance(models[model_name]['gdrive_id'], list):
        ...
        if dataset_ == BenchmarkDataset.avffia and 'Standard' in model_name:
            return model.eval()
        ...
        if dataset_ == BenchmarkDataset.avffia:
...
def _safe_load_state_dict(model: nn.Module, model_name: str,
    ...
    try:
        ...
        if (model_name in known_failing_models or dataset_ == BenchmarkDataset.avffia
