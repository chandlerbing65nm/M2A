...
from .x_vitb16_cmae_384 import create_model_cmae as create_model_vitb16_cmae
...
common_corruptions = OrderedDict([
    ...
    ('Standard_ViT_B', {
        'model': lambda: modify_head(create_model_vitb16("vit_base_patch16_384", pretrained=False)),
        'gdrive_id': '',
    }),
    ('Standard_VIT_B_REM', {
    'model': lambda: modify_head(create_model_vitb16_rem("vit_base_patch16_384", pretrained=False)),
    'gdrive_id': '',
    }),
    ('Standard_VIT_B_CMAE', {
    'model': lambda: modify_head(create_model_vitb16_cmae("vit_base_patch16_384", pretrained=False)),
    'gdrive_id': '',
    }),
])
