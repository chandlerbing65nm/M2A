...
from datasets.corruptions_datasets import create_cifarc_dataset, create_imagenetc_dataset, create_mrsffiac_dataset
...
def get_transform(dataset_name: str, adaptation: str, preprocess: Union[transforms.Compose, None], use_clip: bool, n_views: int = 64):
    ...
    if use_clip:
        ...
        if dataset_name in ["cifar10", "cifar100"]:
            ...
            transform = None
        elif dataset_name in ["mrsffia_c"]:
...
def get_test_loader(setting: str, adaptation: str, dataset_name: str, preprocess: Union[transforms.Compose, None],
    ...
    if domain_name == "none":
        ...
        elif dataset_name == "mrsffia_c":
            test_dataset = create_mrsffiac_dataset(
                severity=severity,
                data_dir=data_dir,
                corruption=domain_name,
                corruptions_seq=domain_names_all,
