...
def main():
    ...
    parser.add_argument('--ckpt_dir', type=str, default='/users/doloriel/work/Repo/M2A/ckpt',
                        help='Checkpoint directory (used by robustbench.load_model)')
    parser.add_argument('--checkpoint', type=str, default='/users/doloriel/work/Repo/M2A/ckpt/vit_base_384_cifar10.t7',
