...
def main():
    ...
    parser.add_argument("--labels", nargs="+", default=["10%", "20%", "50%", "100%"], help="Sample sizes labels and grouping size")
    parser.add_argument("--outdir", type=str, default="data_cifar/plots/M2A/Misc/cifar10")
    ...
    if args.radar:
        ...
        ax.set_xlabel("Samples per Corruption", fontsize=float(plt.rcParams.get('font.size', 10.0)) * 1.5)
        ax.set_ylabel("")
