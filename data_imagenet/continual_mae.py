...
import mae_transforms as mae_transforms
...
def get_tta_transforms(gaussian_std: float=0.005, soft=False, clip_inputs=False):
    ...
    tta_transforms = transforms.Compose([
        mae_transforms.Clip(0.0, 1.0), 
        mae_transforms.ColorJitterPro(
        ...
        mae_transforms.GaussianNoise(0, gaussian_std),
        mae_transforms.Clip(clip_min, clip_max)
    ])
